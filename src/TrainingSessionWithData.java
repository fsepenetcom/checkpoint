...
public class TrainingSessionWithData {
    ...
    public TrainingSessionWithData(List<TrainingSessionData> trainingSessionData,int idTrainingSession, Date startTime, Date endTime,String userUsername) {
    ...
    public TrainingSessionWithData() {
